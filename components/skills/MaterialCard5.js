...
export default class MaterialCard5 extends Component {
  render() {
    ...
    return (
      <View style={[styles.container, this.props.style]}>
        ...
        <Image
          source={require("../../assets/images/JPEG_20190217_162050.jpg")}
          style={styles.cardItemImagePlace}
        />
        <View style={styles.bodyContent}>
          <Text style={styles.titleStyle}>Programming Skills</Text>
